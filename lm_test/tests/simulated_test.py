...
class SimulatedSubmissionTest(test_base.LmTest):
    ...
    def __init__(
        ...
        self.test_name = (
            'Simulated job test (submit: {}, wait: {}, validate: {})'.format(
    ...
    def run_test(self):
        ...
        if self.submit_pass:
            ...
            raise test_base.LmTestFailure('Simulated job submission failed.')
...
class SimulatedWaitTest(test_base.LmTest):
    ...
    def __init__(
        ...
        self.validate_pass = validate_pass
        self.test_name = (
            'Simulated job wait test (job id: {}, timeout: {}, validate: {})'.format(
    ...
    def run_test(self):
        ...
        if self.wait_timeout < 0:
            ...
            self.add_new_test(SimulatedValidateTest(self.wait_id, self.validate_pass))
        else:
            self.add_new_test(
                SimulatedWaitTest(
                    self.wait_id,
...
class SimulatedValidateTest(test_base.LmTest):
    ...
    def __init__(self, wait_id, validate_pass, delay_time=0, delay_interval=60):
        ...
        self.validate_pass = validate_pass
        self.test_name = (
            'Simulated job validate test (job id: {}, validate: {})'.format(
